...
struct skyBoxVertex {
    ...
    static std::array<VkVertexInputAttributeDescription, 2> getAttributeDescriptions() {
        ...
        attributeDescriptions[1].offset = offsetof(skyBoxVertex, textureCoords);
...
struct textVertex{
    ...
    static std::array<VkVertexInputAttributeDescription, 3> getAttributeDescriptions() {
        ...
        // Texture coordinate attribute
        attributeDescriptions[2].binding = 0;  // Same binding as position
        attributeDescriptions[2].location = 2;  // Shader location for texture coordinates
        attributeDescriptions[2].format = VK_FORMAT_R32_SINT;  // vec2 in GLSL
        attributeDescriptions[2].offset = offsetof(textVertex, imageIndex);  // Offset in the vertex structure
...
struct menuVertex{
    ...
    static VkVertexInputBindingDescription getBindingDescription() {
        VkVertexInputBindingDescription bindingDescription{};
        bindingDescription.binding = 0;
        bindingDescription.stride = sizeof(menuVertex);
        bindingDescription.inputRate = VK_VERTEX_INPUT_RATE_VERTEX;
    ...
    static std::array<VkVertexInputAttributeDescription, 2> getAttributeDescriptions() {
        ...
        attributeDescriptions[0].location = 0;  // Shader location for position
        attributeDescriptions[0].format = VK_FORMAT_R32G32_SFLOAT;  // vec2 in GLSL
        attributeDescriptions[0].offset = offsetof(menuVertex, pos);  // Offset in the vertex structure

        // Texture coordinate attribute
        attributeDescriptions[1].binding = 0;  // Same binding as position
        attributeDescriptions[1].location = 1;  // Shader location for texture coordinates
        attributeDescriptions[1].format = VK_FORMAT_R32G32_SFLOAT;  // vec2 in GLSL
        attributeDescriptions[1].offset = offsetof(menuVertex, texCoord);  // Offset in the vertex structure
